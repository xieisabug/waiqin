...
/**
 * 定时任务管理类，主要用于定时任务的启动，增加，删除，修改管理
 * 
 * @author Administrator
 * 
 */
public class QuartzManager {
	private static SchedulerFactory sf = new StdSchedulerFactory();// 任务工厂
	private static String JOB_GROUP_NAME = "HTXX";
	private static String TRIGGER_GROUP_NAME = "SEND_XML"; 
