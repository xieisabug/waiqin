...
package com.sealion.serviceassistant.recorder;
...
import com.sealion.serviceassistant.SoundRecorder;
import com.sealion.serviceassistant.R.drawable;
import com.sealion.serviceassistant.R.string;
...
public class RecorderService extends Service implements MediaRecorder.OnErrorListener
{
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		if (bundle != null && bundle.containsKey(ACTION_NAME))
		{
			...
			case ACTION_START_RECORDING:
				localStartRecording(bundle.getInt(ACTION_PARAM_FORMAT), bundle.getString(ACTION_PARAM_PATH), bundle.getBoolean(ACTION_PARAM_HIGH_QUALITY),
	...
	private void showRecordingNotification()
	{
		...
		pendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, SoundRecorder.class), 0);

		notification.setLatestEventInfo(this, getString(R.string.app_name), getString(R.string.notification_recording), pendingIntent);
	...
	private void showLowStorageNotification(int minutes)
	{
		...
		{
			mLowStorageNotification = new Notification(R.drawable.stat_sys_call_record_full, getString(R.string.notification_recording), System.currentTimeMillis());
		...
		mLowStorageNotification.setLatestEventInfo(this, getString(R.string.app_name), getString(R.string.notification_warning, minutes), pendingIntent);
	...
	private void showStoppedNotification()
	{
		...
		notification.setLatestEventInfo(this, getString(R.string.app_name), getString(R.string.notification_stopped), pendingIntent);
	...
	public static int getMaxAmplitude() //获取最大振幅
	{
