package com.sealion.serviceassistant.print;
...
import com.sealion.serviceassistant.BTPrinterActivity;
...
public class BluetoothService
{
	...
	private void connectionFailed()
	{
		...
		Bundle bundle = new Bundle();
		bundle.putString(BTPrinterActivity.TOAST, "不能够连接到设备！");
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
	...
	private void connectionLost()
	{
		...
		Message msg = mHandler.obtainMessage(BTPrinterActivity.MESSAGE_TOAST);
		Bundle bundle = new Bundle();
		bundle.putString(BTPrinterActivity.TOAST, "设备连接丢失,请重新连接!");
		msg.setData(bundle);
		mHandler.sendMessage(msg);
	}
